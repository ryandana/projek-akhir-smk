  ...
  return (
    <div
      className={`flex flex-col gap-2 ${
        depth > 0 ? "ml-8 md:ml-12 border-l-2 pl-4 border-base-200" : ""
      }`}
    >
      {/* Comment Display */}
        ...
        <div className="flex-1 space-y-1">
          ...
          <div className="flex items-center gap-4 pt-1">
            <button
              ...
              className="text-xs font-semibold text-neutral hover:text-neutral-focus flex items-center gap-1"
            >
              Reply
            </button>
          </div>
        ...
        <form onSubmit={handleSubmit} className="flex gap-4 items-start">
          ...
          <div className="flex-1 flex gap-2 items-center">
            ...
            <button
              ...
              className="btn btn-neutral rounded-full px-2"
            >
              <IconSend />
            </button>
          </div>
